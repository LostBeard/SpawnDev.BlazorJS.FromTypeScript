...
namespace Sdcb.TypeScript.TsParser
{
    public class Parser
    {
        ...
        public bool IsStartOfMappedType()
        {
            ...
            NextToken();
            var token = Token();
            if (token == SyntaxKind.ReadonlyKeyword || token == SyntaxKind.OverrideKeyword)
            {
        ...
        public MappedTypeNode ParseMappedType()
        {
            ...
            node.OverrideToken = (OverrideToken)ParseOptionalToken<OverrideToken>(SyntaxKind.OverrideKeyword);
